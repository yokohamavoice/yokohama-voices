# ヨコハマの声
作成・運営：すすすす。問い合わせ：susususu.yoko@gmail.com。

ソースコード： https://github.com/yokohamavoice/yokohama-voices
公開データ： https://github.com/yokohamavoice/yokohama-voices-data

横浜の政策分野をまたいで回答し、セッションの最後に意見を投稿する試作です。40件の初期意見と8タグを含みます。原データはD1、分析の固定結果と公開候補はR2に保存します。
